...
function LeftSideBar({ slideIn, handleSlideIn, isNight }) {
...
console.log(userId);
  ...
  return (
    <>
      <div className = {isNight? "leftSideDark":"left_container_side"} style={slideIn ? slideInStyle : slideOutStyle}>
        ...
        <ul className="public_lists">
          ...
          <li onClick={() => handleSlideIn()}>
            <Link
              className={`remove_left_link_style ${location.pathname === `/UserPlan/${userId}` ? 'active' : ''}`}
              to={`/UserPlan/${userId}`}
            >
              <p>Subscription</p>
            </Link>
          ...
          <li onClick={() => handleSlideIn()}>
            <Link
              className={`remove_left_link_style ${location.pathname === `/UserHistory/${userId}` ? 'active' : ''}`}
          ...
          <li onClick={() => handleSlideIn()}>
            <Link
              className={`remove_left_link_style ${location.pathname === `/userLocation` ? 'active' : ''}`}
              to={`/userLocation`}
            >
              <p>Location</p>
            </Link>
          ...
          <li onClick={() => handleSlideIn()}>
            <Link
              className={`remove_left_link_style ${location.pathname === `/publicPage` ? 'active' : ''}`}
              to={`/publicPage`}
            >
              <p>Public Place</p>
            </Link>
